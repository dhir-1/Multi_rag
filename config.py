...
# Prevent OpenBLAS memory allocation failures on Windows multi-threading
...
RERANKER_MODEL_NAME: str = os.getenv("RERANKER_MODEL_NAME", "ms-marco-MiniLM-L-12-v2").strip()
...
ABSTENTION_THRESHOLD: float = _get_float_env("RERANKER_ABSTENTION_THRESHOLD", 0.001)
...
RERANK_TOP_K: int = _get_int_env("RERANK_TOP_K", 8)
FAST_PATH_TOP_K: int = _get_int_env("FAST_PATH_TOP_K", 8)
...
TECH_10K_DIR: str = os.getenv("TECH_10K_DIR", str(PROJECT_ROOT / "data" / "tech_10k"))
